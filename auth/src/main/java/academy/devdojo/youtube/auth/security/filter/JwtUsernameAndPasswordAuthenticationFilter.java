...
public class JwtUsernameAndPasswordAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) {
        ...
        log.info("Creating the authentication object for the user '{}' and calling" +
                "UserDetailsServiceImpl loadUserByUsername", applicationUser.getUsername());
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult) {
        log.info("Authentication was successful for the user '{}', " +
                "generating JWE token", authResult.getName());
